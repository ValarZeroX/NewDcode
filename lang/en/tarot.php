...
return [
    ...
    "love_1" => "Current Situation",
    "love_2" => "Challenges",
    "love_3" => "Subconscious Feelings",
    "love_4" => "Past Influences",
    "love_5" => "Possible Future",
    "love_6" => "Near Future",
    "love_7" => "Your Current Attitude",
    "love_8" => "External Influences",
    "love_9" => "Hopes and Fears",
    "love_10" => "Final Outcome",
    "celtic_cross_spread" => "Celtic Cross Spread",
    "free_love_celtic_cross_spread" => "Free Love Tarot Reading - Celtic Cross Spread",
    "celtic_cross_spread_0" => "The Celtic Cross Spread is one of the most classic and widely used spreads in tarot. This spread consists of ten cards and is suitable for in-depth analysis and answering various questions, especially those involving complex situations and multifaceted issues.",
    "love_11" => "Focus on your question. Choose ten cards. The cards will answer your question.",
    "love_12" => "Current Situation: This card represents the current situation or the core of the issue.",
    "love_13" => "Challenges: This card indicates the challenges or obstacles you are currently facing.",
    "love_14" => "Subconscious Feelings: This card reveals your subconscious emotions, fears, or expectations.",
    "love_15" => "Past Influences: This card represents past events or influences that are important to the current situation.",
    "love_16" => "Possible Future: This card shows the possible outcome if the situation continues on its current path.",
    "love_17" => "Near Future: This card indicates upcoming events or developments.",
    "love_18" => "Your Current Attitude: This card represents your attitude and actions regarding the issue.",
    "love_19" => "External Influences: This card shows external factors and other people's influence on you.",
    "love_20" => "Hopes and Fears: This card reveals your hopes and fears that affect your decisions and actions.",
    "love_21" => "Final Outcome: This card predicts the final outcome or resolution of the issue.",
    "love_22" => "Current Situation: The current state of the relationship, possibly the condition of the love.",
    "love_23" => "Challenges: The difficulties you are facing, possibly communication issues or external pressure.",
    "love_24" => "Subconscious Feelings: Your true feelings deep inside about this relationship.",
    "love_25" => "Past Influences: Past experiences that have influenced the current relationship.",
    "love_26" => "Possible Future: How the relationship might develop if no changes are made.",
    "love_27" => "Near Future: Specific changes in the relationship in the near future.",
    "love_28" => "Your Current Attitude: Your attitude and actions regarding this relationship.",
    "love_29" => "External Influences: Influences from family, friends, or other external factors.",
    "love_30" => "Hopes and Fears: Your hopes and concerns about this relationship.",
    "love_31" => "Final Outcome: The final direction of the relationship.",
    "example" => "Example",
];
