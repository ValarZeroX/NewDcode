...
@section('title', __('zodiac.zodiac_date_free'))
@section('description', __('description.zodiac_date'))

@section('main')
<div class="container">
    <h1>{{ __('zodiac.zodiac_date_52')}}</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/language/{{ app()->getLocale() }}">Dcode</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('zodiac.zodiac_date_52')}}</li>
        </ol>
    </nav>
