...
@section('title', 'DCode 塔羅占卜、詩籤解籤、星座運勢')
@section('description',
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <div class="card-header text-center">星盤</div>
          <div class="card-body">
            <p class="card-text">星盤是根據個人出生時的日期、時間和地點繪製的圖表，展示了各個行星在黃道帶上的位置。透過分析星盤，我們可以瞭解個人的性格特質、適合的職業、感情傾向等。</p>
          </div>
          <div class="card-footer text-center">
              <div class="btn-group">
                <a href="/astrology/zodiac/date" class="btn btn-sm btn-outline-secondary" role="button">前往星盤</a>
              </div>
          </div>
        </div>
      </div>
    </div>
    <h2 class="mt-5">每日塔羅占卜系列</h2>
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
      <div class="col">
        <div class="card shadow-sm">
          <div class="image-container card-img-top">
