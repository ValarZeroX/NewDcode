...
<div class="container">
    ...
    <div class="draw">
        ...
        <div class="deck level3">
            @for ($i = 0; $i < 14; $i++) <div class="tarot-cards select-cards" id="tarot-{{$i+36}}"></div>@endfor
        </div>
    </div>
    ...
    <div class="alert alert-warning info-box" role="alert">
        ...
        <a class="btn  btn-success" href="/language/{{ app()->getLocale() }}/tarot/fourelement" role="button">{{ __('tarot.draw_another_tarot_card')}}</a>
    </div>
</div>
<script>
