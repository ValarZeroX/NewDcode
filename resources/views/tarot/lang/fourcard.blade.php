...
@section('main')
                                        ...
                                        <div class="well card">
                                            ...
                                            @if($value['reversed'] == 1)
                                                                    <p><strong>{{ __('tarot.reversed_keyword')}} :</strong>
                                                                        @foreach ($value['reversed_keyword'] as $val)<s
                                                                        p                           an class="badge rounded-pill bg-warning  text-dark">{{$val }}</span> @endforeach</P>
                                            @else
                                                                    <p><strong>{{ __('tarot.upright_keyword')}} :</strong>
                                                                        @foreach ($value['upright_keyword'] as $val)<s
                                                                        p                           an class="badge rounded-pill bg-info text-dark">{{$val }}</span> @endforeach</P>
                                            @endif
    ...
    $sReversed = implode(',', $aReversed);?>
        ...
        <div class="alert alert-warning info-box" role="alert">
            ...
            <a class="btn  btn-success" href="/language/{{ app()->getLocale() }}/tarot/fourcard"
