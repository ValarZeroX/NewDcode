            ...
            <div class="col">
                <div class="info-box">
                    ...
                    @foreach ($data as $key => $value)
                                    ...
                                    <?php    $aID[] = $value['id'];
                        $aReversed[] = $value['reversed'];?>
                    @endforeach
                    <?php $sID = implode(',', $aID);
    $sReversed = implode(',', $aReversed);?>
                    <div class="alert alert-warning" role="alert">
                        <p>{{ __('tarot.share_your_card')}}</p>
                        <a class="btn  btn-success"
                            href="/language/{{ app()->getLocale() }}/tarot/sharetarot/{{$sID}}/{{$sReversed}}/{{$type}}"
                            role="button">{{ __('tarot.share_card')}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-warning info-box" role="alert">
            ...
            <a class="btn  btn-success" href="/language/{{ app()->getLocale() }}/tarot/six-pointed-star"
