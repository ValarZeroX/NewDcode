    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center result">
            <div class="tarot-card">
                <img src="/images/deck/{{$data['image_key']}}.jpg"
                    class="figure-img img-fluid card-hide card1 @if($data['reversed'] == 1) reversed @endif"
                    alt="{{$data['name']}}">
                ...
                <div class="info-box">
                    ...
                    <div class="well card">
                        ...
                        <a class="btn btn-sm btn-outline-secondary"
                            href="/language/{{ app()->getLocale() }}/tarot/detail/{{$data['number']}}"
        ...
        <div class="alert alert-warning info-box" role="alert">
            ...
            <a class="btn  btn-success" href="/language/{{ app()->getLocale() }}/tarot/onecard"
