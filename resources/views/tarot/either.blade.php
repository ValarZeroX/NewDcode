...
@section('title', $title)
@section('description', "面臨二選一狀況時，最常用的占卜法。;例如:該選擇A君還是B君?該繼續升學或是就?諸如此類有關抉擇的問題，能夠提供相當好的建議與解答。")
...
<div class="container">
    ...
    <div class="alert alert-warning info-box" role="alert">
        ...
        <a class="btn  btn-success" href="/tarot/either" role="button">再抽一次</a>
    </div>
</div>
<script>
