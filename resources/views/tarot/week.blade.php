...
@section('title', $title)
@section('description', "每周運勢占卜 - 占卜解讀的順序不一定要硬性依照日期順序，而廣泛應用在整體運勢解說，這時候就必須具備一些占星學的小常識。")
...
<div class="container">
    ...
    <div class="alert alert-warning info-box" role="alert">
        ...
        <a class="btn  btn-success" href="/tarot/week" role="button">再抽一次</a>
    </div>
</div>
<script>
